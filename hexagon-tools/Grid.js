define(
	...
	function(HT) {
		 ...
		 * @constructor
		 */
		function HexGrid(/*double*/ width, /*double*/ height) {
		...
		HexGrid.Static = {Letters:'ABCDEFGHIJKLMNOPQRSTUVWXYZ'};

		HexGrid.prototype.GetHexId = function(row, col) {
			var letterIndex = row;
			var letters = "";
			while(letterIndex > 25)
			{
				letters = HexGrid.Static.Letters[letterIndex%26] + letters;
				letterIndex -= 26;
			}
				
			return HexGrid.Static.Letters[letterIndex] + letters + (col + 1);
		};
		 ...
		 * @return {HT.Hexagon}
		 */
		HexGrid.prototype.GetHexAt = function(/*Point*/ p) {
		 ...
		 * @return {number}
		 */
		HexGrid.prototype.GetHexDistance = function(/*Hexagon*/ h1, /*Hexagon*/ h2) {
		 ...
		 * @return {HT.Hexagon}
		 */
		HexGrid.prototype.GetHexById = function(id) {
